...
class Department:
    ...
    def save(self):
        ...
        Save the object in local dictionary using table row's PK(primary key) as dictionary key
        """
        sql = """
    ...
    #Update the delete method as shown below:
    def delete(self):
    ...
    #Add the new class method find_by_id() to the Department class
    @classmethod
    ...
    #Add the new class method find_by_name() to the Department class
    @classmethod
